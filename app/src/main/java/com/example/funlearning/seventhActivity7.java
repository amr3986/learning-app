...
public class seventhActivity7 extends AppCompatActivity {
    int QNo;
    TextView starV;
    TextView Qusno;
    Button but;
    ...
    public void correct(View view){
        ...
        final Intent golast = new Intent();
        golast.setClass(this, lastActivity.class);
        golast.putExtra("str",starNo);
        golast.putExtra("pr",QNo);
